...
split = np.array_split(test, [4], axis=1)

i = split[0]
t = split[1]

t_matrix = np.zeros((30, 3))
...
for row in range(test.shape[0]):
	...
	o = nn.eval(it)
	print("Output: " + str(np.round(o)) + "\tTarget: " + str(tp) + "\tClassification: " + str((np.round(o)==tp).all()))

	if (np.round(o)==tp).all():
		correct += 1

print("Correct samples: " + str(correct))
